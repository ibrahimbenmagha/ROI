  ...
  const calculateRoi = async () => {
    ...
    try {
      ...
      const result = {
        ...
        total_samples_distributed: response.data.results.total_samples_distributed,
        total_patients_received_samples: response.data.results.total_patients_received_samples,
        patients_prescribed_after_sample: response.data.results.patients_prescribed_after_sample,
