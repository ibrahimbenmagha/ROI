...
Route::post('createActivity', [ActivitiesController::class, 'createActivity']); //work

Route::get('getAllActivityNotCustum', [ActivitiesController::class, 'getAllActivityNotCustum']); //works
