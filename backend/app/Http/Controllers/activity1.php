    ...
    public function insertIntoTable1(Request $request)
{
    $validated = $request->validate([
        ...
        'E' => 'required|numeric|min:0.1', // Nombre moyen d’échantillons donnés par patient
    ...
    // Vérifier si ActByLabo est associé à l'activité de ID 1
    if (!ActivityByLabo::where('id', $ActByLabo)->where('ActivityId', 1)->exists()) {
        return response()->json([
            'message' => 'ActivityByLabo is not associated with Activity ID 1'
        ], 400);
    }
