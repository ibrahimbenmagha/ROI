...
//                     className="block text-sm font-medium text-gray-700 mb-1"
//                   >
//                     Coût variable par email envoyé MAD (M)
//                   </label>
//                   <Input
//                     id="costPerEmail"
//                     type="number"
...
//                     className="block text-sm font-medium text-gray-700 mb-1"
//                   >
//                     Coût fixe total du programme MAD (N)
//                   </label>
//                   <Input
//                     id="fixedCosts"
//                     type="number"
          ...
          <form onSubmit={handleSubmit}>
            <Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label>% de médecins se rappelant avoir reçu l'email (C)</label>
                  <Input
                    type="number"
                    value={percentRememberEmail}
                    onChange={(e) =>
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={valuePerPatient}
                    onChange={(e) =>
                      setValuePerPatient(Number(e.target.value))
                    }
                  />
                </div>
