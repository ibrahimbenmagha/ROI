...
import { Layout, Typography, Card, Divider, Statistic, Alert, Spin, message } from "antd";
import { 
  CalculatorOutlined, 
  ReloadOutlined, 
  CheckCircleOutlined 
...
const CalculateAct3 = () => {
  ...
  const calculateRoi = async () => {
    ...
    const validationChecks = [
      { value: totalDoctors, message: "Nombre total de médecins invalide", minValue: 0 },
      { value: emailsPerDoctor, message: "Nombre d'emails par médecin invalide", minValue: 0 },
      { value: percentRememberEmail, message: "Pourcentage des médecins se rappelant de l'email invalide", minValue: 0, maxValue: 100 },
      { value: percentRememberBrand, message: "Pourcentage des médecins se rappelant de la marque invalide", minValue: 0, maxValue: 100 },
      { value: percentPrescribing, message: "Pourcentage des médecins prescrivant invalide", minValue: 0, maxValue: 100 },
      { value: newPatientsPerDoctor, message: "Nombre de nouveaux patients par médecin invalide", minValue: 0 },
      { value: valuePerPatient, message: "Valeur par patient invalide", minValue: 0 },
