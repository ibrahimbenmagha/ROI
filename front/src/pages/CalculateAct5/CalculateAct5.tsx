...
//                     className="block text-sm font-medium text-gray-700 mb-1"
//                   >
//                     Valeur du revenu par patient incrémental MAD (L)
//                   </label>
//                   <Input
//                     id="valuePerPatient"
//                     type="number"
...
//                     className="block text-sm font-medium text-gray-700 mb-1"
//                   >
//                     Coût variable par table ronde MAD (N)
//                   </label>
//                   <Input
...
//                     className="block text-sm font-medium text-gray-700 mb-1"
//                   >
//                     Coût fixe total du programme MAD (O)
//                   </label>
//                   <Input
//                     id="fixedCosts"
//                     type="number"
...
const CalculateAct5 = () => {
  ...
  const calculateRoi = async () => {
    ...
    if (!validateNumeric(B, 0)) return message.error("Tables rondes par médecin invalide");
    if (!validateNumeric(D, 0)) return message.error("Médecins par table ronde invalide");
    if (!validateNumeric(F, 0, 100)) return message.error("% Perception positive invalide");
    if (!validateNumeric(H, 0, 100)) return message.error("% Prescription invalide");
    if (!validateNumeric(J, 0)) return message.error("Patients par médecin invalide");
    if (!validateNumeric(L, 0)) return message.error("Valeur patient invalide");
    if (!validateNumeric(N, 0)) return message.error("Coût table ronde invalide");
          ...
          {calculationResult && (
            <div className="mt-8">
              ...
              <Card className="mt-4">
                ...
                />
                <Text type="secondary">
                  Patients additionnels grâce au programme
                </Text>
              </Card>
