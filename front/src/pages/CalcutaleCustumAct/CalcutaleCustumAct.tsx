...
//           console.error(`Erreur: Valeur manquante pour l'item ${elem.value}`);
//           hasError = true;
//           return;
//         }
...
//     if (hasError) {
//       console.error("Erreur dans l'évaluation de l'expression: Données manquantes");
//       return 0;
//     }
...
//       console.log("Calculated Items:", updatedCalculatedItems);
...
//       } else {
//         setRoiFinal(0);
//         console.log("No ROI item found, ROI Final set to 0");
//       }
...
//           name: item.name,
//           value: item.name.toLowerCase().includes("roi") ? roiFinal : item.value || 0,
//         })),
//       };
