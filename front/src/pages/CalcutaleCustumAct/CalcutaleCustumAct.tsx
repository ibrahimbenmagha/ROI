...
//   const showConfirm = () => {
//     confirm({
//       title: 'Êtes-vous sûr de vouloir soumettre cette activité?',
//       icon: <ExclamationCircleOutlined />,
//       content: 'Cette action va enregistrer l\'activité dans la base de données',
//       onOk() {
//         handleSubmit();
//       },
//       onCancel() {
...
//       const response = await axiosInstance.post("CustomActivitySubmit", formData);
      
//       if (response.status === 201 || response.status === 200) {
//         message.success("L'activité a été enregistrée avec succès.");
